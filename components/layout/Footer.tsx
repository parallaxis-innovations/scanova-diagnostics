				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
					...
					<div>
						...
						<p className="text-gray-200 mb-4">
							NABL-accredited diagnostic center providing accurate, reliable
						...
						<div className="flex gap-4">
							<Facebook
								size={20}
								className="hover:text-scanova-teal cursor-pointer transition-colors"
							/>
							<Twitter
								size={20}
								className="hover:text-scanova-teal cursor-pointer transition-colors"
					...
					<div>
						...
						<div className="mt-6">
							...
							<div className="text-gray-200 text-sm">
								...
								<p className="text-scanova-teal font-medium mt-1">
									Home Collection: 24/7
								</p>
							</div>
						</div>
					</div>
